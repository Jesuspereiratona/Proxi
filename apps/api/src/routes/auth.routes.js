...
const limitarTasaRegistro = require('../middlewares/limitar-tasa-registro.middleware');
const verificarCsrf = require('../middlewares/verificar-csrf.middleware');
const esquemas = require('../schemas/auth.schemas');

const router = Router();

router.post('/registro', limitarTasaRegistro, validar(esquemas.registroEsquema), controller.registro);
