...
| Límite de tasa | 300 peticiones cada 15 min. La clave es el **usuario** cuando hay sesión válida y la IP cuando no: con la IP sola, toda la red de la universidad compartía presupuesto y los estudiantes se bloqueaban entre ellos. El token se verifica, no solo se lee |
